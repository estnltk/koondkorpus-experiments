...
_pronConversions = ( ("emb\+.*",             ("det",)),
                     ...
                     ("miski.*",             ("indef",)),
                     ("mis\+.*",             ("inter_rel",)),
                     ("mis_sugune.*",        ("inter_rel",)),
                     ("miski\+.*",           ("inter_rel",)),
                     ("miski_sugune.*",      ("inter_rel",)),
                     ("misu=?ke(ne)?\+.*",   ("dem",)),
                     ("mitme_sugune.*",      ("indef",)),
                     ("mitme_taoline.*",     ("indef",)),
                     ("mitmendik\+.*",       ("inter_rel",)),
                     ("mitmes\+.*",          ("inter_rel", "indef")),
                     ("mi=?tu.*",            ("indef",)),
                     ("miuke(ne)?\+.*",      ("inter_rel",)),
                     ("muist\+.*",           ("indef",)),
                     ("muu.*",               ("indef",)),
    ...
    for token, lemma, root_ec in token_lemma_rootec:
        ...
        for pattern, pronoun_type in _pronConversions:
            if search(pattern, root_ec):
                match = True
                token_lemma_type.append({'token': token, 'lemma': lemma, 'pronoun_type': ' '.join(pronoun_type)})
                break
        if not match:
